...
| **BB8006** | [27.03.2026]   | [[https://github.com/fabianbaechli/sopra-fs26-group-41-client/commit/b62ab550ee4d43f758bf713ce7245bdb6e961058] | [Changed app page.tsx logic to redirect correctly] | [Correct redirection of the user so that if a token already exists the user will be redirected to the users/me page automatically or if not the user has to loging by being redirected to the login page] |
|                    | [date]   | [Link to Commit 2] | [Brief description of the task] | [Why this contribution is relevant] |
