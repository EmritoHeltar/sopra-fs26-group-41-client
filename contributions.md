...
| **BB8006** | [28.03.2026]   | [https://github.com/fabianbaechli/sopra-fs26-group-41-client/commit/65dddcad666d1f3f8acc86b0a81491b67ed91d3e)] | Implemented login page UI and authentification logic (#1) | Added the login screen UI and wired it up to the /login endpoint. It now handles loading states and displays server errors directly on the form |
